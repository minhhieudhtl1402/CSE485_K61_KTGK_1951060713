...
<body>
   ...
   <h1 class="text-center mt-3">Thêm </h1>
    <form action="" method="post">
        ...
        <input type="text" class="form-control" name="txtTrinhDo ">


        <label  class="form-label" >Chuyên Môn</label>
        <input type=" text" class="form-control" name="txtChuyenMon">


        <label  class="form-label">Học Hàm</label>
        <input type="text" class="form-control" name="txtHocHam">
        <label  class="form-label">Học Vị</label>
        <input type="text" class="form-control" name="txtHocVi">
